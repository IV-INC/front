  ...
  public: {
    Tables: {
      ...
      companies: {
        ...
        Insert: Omit<Database['public']['Tables']['companies']['Row'], 'id' | 'created_at' | 'updated_at' | 'is_visible' | 'approval_status' | 'reviewed_at' | 'reviewed_by' | 'rejection_reason' | 'stripe_connected' | 'ga4_connected' | 'ga4_property_id' | 'last_data_update' | 'pinned_until' | 'is_blocked'> & { is_visible?: boolean; approval_status?: ApprovalStatus; stripe_connected?: boolean; ga4_connected?: boolean; ga4_property_id?: string | null };
        Update: Partial<Database['public']['Tables']['companies']['Insert']> & { is_visible?: boolean; approval_status?: ApprovalStatus; reviewed_at?: string; reviewed_by?: string | null; rejection_reason?: string | null; stripe_connected?: boolean; ga4_connected?: boolean; ga4_property_id?: string | null; pinned_until?: string | null; is_blocked?: boolean };
        Relationships: [];
      };
      executives: {
        Row: {
